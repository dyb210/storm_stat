...
//        try {
//            connection = ConnectionFactory.createConnection(localConfig);
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
//        try {
...
//        }
    ...
    public static void getResultByVersion(String tableName, String rowKey,
        ...
        for (Cell kv : result.listCells()) {
            ...
            System.out
                    .println("qualifier:" + Bytes.toString(kv.getQualifierArray()));
     ...
     * @throws IOException
     */
    public static void changeEnableTable(String tableName) throws IOException {
        Admin admin = connection.getAdmin();
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 创建表
//        String tableName = "blog5";
//        String[] family = {"article", "author"};
        //creatTable(tableName, family);

       // changeEnableTable(tableName);
        // 为表添加数据
